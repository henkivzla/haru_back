...
CREATE TABLE IF NOT EXISTS tiendas (
  ...
  modo_ventas ENUM('turno','directo') NOT NULL DEFAULT 'turno',
  activo      TINYINT(1)   NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS cajas (
  ...
  monto_cierre_usd   DECIMAL(12,2) NULL,
  monto_cierre_bs    DECIMAL(12,2) NULL,
  monto_cierre_eur   DECIMAL(12,2) NULL,
  desglose_cierre_usd JSON         NULL,
  desglose_cierre_bs  JSON         NULL,
  desglose_cierre_eur JSON         NULL,
  ventas_total_usd   DECIMAL(12,2) NULL,
  ventas_total_bs    DECIMAL(12,2) NULL,
  ventas_total_eur   DECIMAL(12,2) NULL,
  ventas_cantidad    INT UNSIGNED  NULL DEFAULT 0,
  tasa_bcv_cierre    DECIMAL(12,4) NULL,
  tasa_eur_cierre    DECIMAL(12,4) NULL,
  ...
  FOREIGN KEY (cerrado_por_id) REFERENCES usuarios(id) ON DELETE SET NULL,
  INDEX idx_tienda_estado (tienda_id, estado),
  INDEX idx_tienda_cerrada (tienda_id, cerrada_at),
...
CREATE TABLE IF NOT EXISTS productos (
  ...
  moneda_entrada ENUM('USD','VES','EUR') NOT NULL DEFAULT 'USD',
  precio_entrada DECIMAL(10,2) NOT NULL DEFAULT 0.00,
  tasa_bcv_snapshot DECIMAL(12,4) NULL,
  tasa_eur_snapshot DECIMAL(12,4) NULL,
  precio_bs_snapshot DECIMAL(12,2) NULL,
  precio_eur_snapshot DECIMAL(12,2) NULL,
  precio_registrado_at TIMESTAMP NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS ventas (
  ...
  metodo_pago       ENUM('EFECTIVO_USD','EFECTIVO_BS','EFECTIVO_EUR','PAGO_MOVIL','ZELLE','PUNTO_VENTA','BINANCE','ZINLI','PAYPAL','MIXTO') NOT NULL,
...
CREATE TABLE IF NOT EXISTS gastos_administrativos (
  ...
  monto_usd   DECIMAL(10,2) NOT NULL,
  moneda_entrada ENUM('USD','VES','EUR') NOT NULL DEFAULT 'USD',
  monto_entrada DECIMAL(12,2) NOT NULL DEFAULT 0.00,
  tasa_bcv_snapshot DECIMAL(12,4) NULL,
  tasa_eur_snapshot DECIMAL(12,4) NULL,
  monto_bs_snapshot DECIMAL(12,2) NULL,
  monto_eur_snapshot DECIMAL(12,2) NULL,
